...
Problem * ProblemFactory::getProblem(char * name, int argc, char ** argv) {
...
else if (strcmp(name, "WFG1")==0) { // WFG1
    if (argc==0)
      return new WFG1("Real");
    else if (argc==1)
      return new WFG1(argv[0]);
    else if (argc==2)
      return new WFG1(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG1(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG1 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG2")==0) { // WFG2
    if (argc==0)
      return new WFG2("Real");
    else if (argc==1)
      return new WFG2(argv[0]);
    else if (argc==2)
      return new WFG2(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG2(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG2 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG3")==0) { // WFG3
    if (argc==0)
      return new WFG3("Real");
    else if (argc==1)
      return new WFG3(argv[0]);
    else if (argc==2)
      return new WFG3(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG3(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG3 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG4")==0) { // WFG4
    if (argc==0)
      return new WFG4("Real");
    else if (argc==1)
      return new WFG4(argv[0]);
    else if (argc==2)
      return new WFG4(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG4(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG4 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG5")==0) { // WFG5
    if (argc==0)
      return new WFG5("Real");
    else if (argc==1)
      return new WFG5(argv[0]);
    else if (argc==2)
      return new WFG5(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG5(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG5 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG6")==0) { // WFG6
    if (argc==0)
      return new WFG6("Real");
    else if (argc==1)
      return new WFG6(argv[0]);
    else if (argc==2)
      return new WFG6(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG6(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG6 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG7")==0) { // WFG7
    if (argc==0)
      return new WFG7("Real");
    else if (argc==1)
      return new WFG7(argv[0]);
    else if (argc==2)
      return new WFG7(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG7(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG7 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG8")==0) { // WFG8
    if (argc==0)
      return new WFG8("Real");
    else if (argc==1)
      return new WFG8(argv[0]);
    else if (argc==2)
      return new WFG8(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG8(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG8 problem." << endl;
      exit(-1);
    }
  }
else if (strcmp(name, "WFG9")==0) { // WFG9
    if (argc==0)
      return new WFG9("Real");
    else if (argc==1)
      return new WFG9(argv[0]);
    else if (argc==2)
      return new WFG9(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new WFG9(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for WFG9 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF1")==0) { // UF1
    if (argc==0)
      return new UF1("Real");
    else if (argc==1)
      return new UF1(argv[0]);
    else if (argc==2)
      return new UF1(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF1(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF1 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF2")==0) { // UF2
    if (argc==0)
      return new UF2("Real");
    else if (argc==1)
      return new UF2(argv[0]);
    else if (argc==2)
      return new UF2(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF2(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF2 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF3")==0) { // UF3
    if (argc==0)
      return new UF3("Real");
    else if (argc==1)
      return new UF3(argv[0]);
    else if (argc==2)
      return new UF3(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF3(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF3 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF4")==0) { // UF4
    if (argc==0)
      return new UF4("Real");
    else if (argc==1)
      return new UF4(argv[0]);
    else if (argc==2)
      return new UF4(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF4(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF4 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF5")==0) { // UF5
    if (argc==0)
      return new UF5("Real");
    else if (argc==1)
      return new UF5(argv[0]);
    else if (argc==2)
      return new UF5(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF5(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF5 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF6")==0) { // UF6
    if (argc==0)
      return new UF6("Real");
    else if (argc==1)
      return new UF6(argv[0]);
    else if (argc==2)
      return new UF6(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF6(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF6 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF7")==0) { // UF7
    if (argc==0)
      return new UF7("Real");
    else if (argc==1)
      return new UF7(argv[0]);
    else if (argc==2)
      return new UF7(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF7(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF7 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF8")==0) { // UF8
    if (argc==0)
      return new UF8("Real");
    else if (argc==1)
      return new UF8(argv[0]);
    else if (argc==2)
      return new UF8(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF8(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF8 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF9")==0) { // UF9
    if (argc==0)
      return new UF9("Real");
    else if (argc==1)
      return new UF9(argv[0]);
    else if (argc==2)
      return new UF9(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF9(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF9 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "UF10")==0) { // UF10
    if (argc==0)
      return new UF10("Real");
    else if (argc==1)
      return new UF10(argv[0]);
    else if (argc==2)
      return new UF10(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new UF10(argv[0], atoi(argv[1]), atoi(argv[2]));
    else {
      cerr << "Incorrect number of arguments for UF10 problem." << endl;
      exit(-1);
    }
  }
 ...
 else if (strcmp(name, "BT1")==0) { // BT1
    if (argc==0)
      return new BT1("Real");
    else if (argc==1)
      return new BT1(argv[0]);
    else if (argc==2)
      return new BT1(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT1(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT1(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT1 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT2")==0) { // BT2
    if (argc==0)
      return new BT2("Real");
    else if (argc==1)
      return new BT2(argv[0]);
    else if (argc==2)
      return new BT2(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT2(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT2(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT2 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT3")==0) { // BT3
    if (argc==0)
      return new BT3("Real");
    else if (argc==1)
      return new BT3(argv[0]);
    else if (argc==2)
      return new BT3(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT3(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT3(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT3 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT4")==0) { // BT4
    if (argc==0)
      return new BT4("Real");
    else if (argc==1)
      return new BT4(argv[0]);
    else if (argc==2)
      return new BT4(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT4(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT4(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT4 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT5")==0) { // BT5
    if (argc==0)
      return new BT5("Real");
    else if (argc==1)
      return new BT5(argv[0]);
    else if (argc==2)
      return new BT5(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT5(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT5(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT5 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT6")==0) { // BT6
    if (argc==0)
      return new BT6("Real");
    else if (argc==1)
      return new BT6(argv[0]);
    else if (argc==2)
      return new BT6(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT6(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT6(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT6 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT7")==0) { // BT7
    if (argc==0)
      return new BT7("Real");
    else if (argc==1)
      return new BT7(argv[0]);
    else if (argc==2)
      return new BT7(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT7(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT7(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT7 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT8")==0) { // BT8
    if (argc==0)
      return new BT8("Real");
    else if (argc==1)
      return new BT8(argv[0]);
    else if (argc==2)
      return new BT8(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT8(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT8(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT8 problem." << endl;
      exit(-1);
    }
  }
 else if (strcmp(name, "BT9")==0) { // BT9
    if (argc==0)
      return new BT9("Real");
    else if (argc==1)
      return new BT9(argv[0]);
    else if (argc==2)
      return new BT9(argv[0], atoi(argv[1]));
    else if (argc==3)
      return new BT9(argv[0], atoi(argv[1]), atoi(argv[2])); //solution type (real), nvar(30), nobj(2)
    else if (argc==4)
      return new BT9(argv[0], atoi(argv[1]), atoi(argv[2]), atof(argv[3])); //solution type (real), nvar(30), nobj(2), ratio bias (1.0)
    else {
      cerr << "Incorrect number of arguments for BT9 problem." << endl;
      exit(-1);
    }
  }
