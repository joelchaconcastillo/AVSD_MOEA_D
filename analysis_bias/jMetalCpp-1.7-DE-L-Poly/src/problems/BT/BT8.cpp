...
const double BT8::PI = 3.141592653589793;

BT8::BT8(string solutionType, int numberOfVariables, int numberOfObjectives, double ratiobias) {
...
long double BT8::D1(long double g, long double theta)
{
 ...
 */
void BT8::evaluate(Solution *solution) {
	XReal * vars = new XReal(solution);
  long double sum1 = 0.0, sum2 = 0.0, theta = 1.0e-3*ratiobias_;
