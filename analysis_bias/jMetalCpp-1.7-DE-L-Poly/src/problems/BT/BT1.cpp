...
const double BT1::PI = 3.141592653589793;

BT1::BT1(string solutionType, int numberOfVariables, int numberOfObjectives, double ratiobias) {
...
long double BT1::D1(long double g, long double theta)
{
 ...
 */
void BT1::evaluate(Solution *solution) {
