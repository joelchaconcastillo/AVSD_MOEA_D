...
const double BT3::PI = 3.141592653589793;

BT3::BT3(string solutionType, int numberOfVariables, int numberOfObjectives, double ratiobias) {
...
long double BT3::D1(long double g, long double theta)
{
 ...
 */
void BT3::evaluate(Solution *solution) {
   ...
   solution->setObjective(0, S1( vars->getValue(0) , 0.02) + sum1);
   solution->setObjective(1, 1.0 - sqrt(S1(vars->getValue(0) , 0.02)) + sum2);
   delete vars ;
} // evaluate
