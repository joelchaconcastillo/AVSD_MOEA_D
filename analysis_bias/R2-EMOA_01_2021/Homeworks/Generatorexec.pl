...
#foreach my $b(("0.5", "0.125", "0.03125", "0.0078125", "0.001953125"))
{
  my @Conf =(
  "BT1 30 2",
  "BT2 30 2",
    ...
    foreach my $F(@G_F)
    {
     foreach my $configuration (@Conf)
     {
     	for(my $Sed = 1; $Sed <=35; $Sed++) ##Realizar 35 ejecuciones con distintas semilla de cada instancia..
     	{
  	      ...
  	      print $fout "/home/joel.chacon/2021_Decomposition/AVSD_MOEA_D/analysis_bias/R2-EMOA_01_2021/r2emoacode-de-ratio-$b/matlab_batcher.sh R2EMOA ".$configuration2[0].",$Sed,".$configuration2[2].",".$configuration2[1].",".$CR.",".$F." \\'".$configuration2[0]."\\',struct\\(\\'nObj\\',\\'".$configuration2[2]."\\',\\'nVar\\',\\'".$configuration2[1]."\\',\\'seed\\',\\'".$Sed."\\',\\'f_name\\',\\'/home/joel.chacon/2021_Decomposition/AVSD_MOEA_D/analysis_bias/R2-EMOA_01_2021/Results/".$configuration2[0]."_".$configuration2[2]."_".$Sed."_nvar_".$configuration2[1]."_CR_".$CR."_F_".$F."_b_".$b."\\',\\'useDE\\',\\'true\\'\\,\\'DE_CombinedCR\\',\\'false\\',\\'DE_CR\\',\\'".$CR."\\',\\'DE_F\\',\\'".$F."\\',\\'maxEval\\',\\'25000000\\'\\) \n";
