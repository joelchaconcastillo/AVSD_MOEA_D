#ifndef _PROBLEM_H
#define _PROBLEM_H
//compile... mex -I. problem.cpp cec09.cpp Toolkit/ExampleProblems.cpp Toolkit/ExampleShapes.cpp Toolkit/ExampleTransitions.cpp Toolkit/FrameworkFunctions.cpp Toolkit/Misc.cpp Toolkit/ShapeFunctions.cpp Toolkit/TransFunctions.cpp
#include <cmath>
#include "cec09.h"
...
double bt1(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
...
double bt2(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
...
double bt3(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
...
double bt4(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
   long double sum1 = 0.0, sum2 = 0.0, theta = (1.0e-8)*ratiobias;
   for(int j = 2; j <= n; j++)
...
double bt5(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
   long double sum1 = 0.0, sum2 = 0.0, theta = 1.0e-10*ratiobias;
   for(int j = 2; j <= n; j++)
...
double bt6(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
...
double bt7(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
...
double bt8(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
   long double sum1 = 0.0, sum2 = 0.0, theta = 1.0e-3*ratiobias;
   for(int j = 2; j <= n; j++)
...
double bt9(vector<double> &f, vector<double> &x, double ratiobias)
{
   int n = x.size();
